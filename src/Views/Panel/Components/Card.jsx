...
export const CardComponent = ({data, setShowOverflow})=>{
	...
	const { store_name, request_code, first_name, middle_name, last_name, address, cellphone, cityName, deliveryStatus, shippmentType, delivery_time, prefered_delivery_time, ...val } = data;
	...
	const NumberDelivery = deliveryStatus ==="pending"?1:deliveryStatus ==="send"?2:deliveryStatus==="delivered"?3:1;
				...
				<Modal show={showModal}>
					<ModalContent>
						...
						<InfoData>
							...
							<input type="submit" value="Definir Hora"></input>
							<p>{ new Date(delivery_time).toLocaleString()}</p>
						</InfoData>
						<InfoData>
							<label>Estado de envío:</label>
							<p>
								<Select
									...
									defaultValue={
										deliveryStatusData.find((x) => x.status === data.deliveryStatus)
											.code
									}
								>
									<option value="" hidden>
